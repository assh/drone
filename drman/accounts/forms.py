...
class CustomerForm(ModelForm):
    date_end = forms.DateField(
        widget=DateInput(), required=False, label="Date of Expiry")
...
class DroneForm(ModelForm):
    ...
    date_purchase = forms.DateField(
        widget=DateInput(), label="Date of Purchase")
    date_operation = forms.DateField(
        widget=DateInput(), required=False, label="Date Operation Started")
    date_shelved = forms.DateField(
        widget=DateInput(), required=False, label="Date Shelved")
